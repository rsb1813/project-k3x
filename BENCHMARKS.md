...
- Shards 1 through 7, 37, 38, 67, and 68 are complete and source-cleaned, for 11 durable ledger units. Shards 37 and 67 resumed existing partial artifacts, so their lower elapsed values are not comparable to full fresh conversion. Shards 38 and 68 are the first full fresh fragments under the combined-audit and immutable-source deletion path; their 697.560/694.020 seconds are manufacturing elapsed, not inference throughput. Conversion timing was not emitted for shards 3, 4, or 6, so no elapsed value is reconstructed from timestamps.
