...
| AURORA | Self-speculative K3 fast-path drafter using reduced Top-K, reduced precision, and resident experts while retaining target verification | Replay provider, adaptive scheduler, and target feedback implemented; CLI integration in progress |
