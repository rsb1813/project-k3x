...
B-0023 validates maximum error 0, zero bypass/fallback, zero measured warm weight H2D, four-to-one synchronization reduction, lower activation H2D and D2H, thirteen layer launches per call, and an exact 14,336-byte routed-norm cold/resident delta at all expert counts. The complete layer still regresses median boundary latency by 1483.27%, 843.70%, and 342.62% at 1, 4, and 16 experts. It remains experimental and non-default.
