...
- [ ] **Step 1: Write the failing real-CUDA resource test**
...
- [ ] **Step 3: Implement focused internal types**
...
- [ ] **Step 4: Implement exact slab preparation**
...
- [ ] **Step 5: Implement consume and complete**
...
- [ ] **Step 6: Run GREEN and sanitizer**
...
- [ ] **Step 1: Write the failing prepared-block oracle test**
...
- [ ] **Step 3: Construct the pipeline only for valid prefetch options**
...
- [ ] **Step 4: Implement prepare and prepared execution**
...
- [ ] **Step 1: Write failing complete-graph parity tests**
...
- [ ] **Step 3: Reorder only the prefetch MoE branch**
...
- [ ] **Step 3: Implement serialization and deterministic checks**
...
- [ ] **Step 4: Run GREEN and one-sample smoke**
...
- [ ] **Step 1: Run complete CPU and CUDA suites**
...
- [ ] **Step 2: Run every CUDA sanitizer target**
...
- [ ] **Step 3: Regenerate and verify the bounded artifact**
...
- [ ] **Step 5: Validate accounting invariants**
...
- [ ] **Step 6: Update durable documents in protocol order**
...
- [ ] **Step 7: Perform one final read-only review**
